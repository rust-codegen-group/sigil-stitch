...
aliases and natural names are soft requests. The resolver assigns every peer
atomically and does not receive an incoming import, current owner, winner/loser
pair, or mutable claim table.

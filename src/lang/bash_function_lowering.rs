//! Bash-owned function declaration grammar.
...
pub(crate) fn lower(
    ...
    let body = function
        .body()
        .expect("Bash function validation requires a body");
...
fn emit_preamble(block: &mut CodeBlockBuilder, lang: &Bash, function: ValidatedFunction<'_>) {
